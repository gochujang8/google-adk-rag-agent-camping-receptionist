...
CORPUS_DISPLAY_NAME = "Camping_La_Rosaleda_corpus"
CORPUS_DESCRIPTION = "Corpus con informacion del Camping La Rosaleda: alojamientos, precios, normas y politicas"
DATA_FILENAME = "INFORMACIÓN COMPLETA DEL CAMPING LA ROSALEDA.docx"
...
def main():
  ...
  data_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", DATA_FILENAME))
  ...
  if os.path.exists(data_path):
    ...
    upload_pdf_to_corpus(
        ...
        pdf_path=data_path,
        display_name=DATA_FILENAME,
        description="Informacion completa del Camping La Rosaleda"
    )
  else:
    print(f"Error: No se encontro el archivo de datos en {data_path}")
